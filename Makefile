...
instantiate-testnet:
	seid tx wasm instantiate ${id} '{"count": 5}' --chain-id atlantic-2 --from dj --gas=4000000 --fees=1000000usei --broadcast-mode=block --label pierprotocol --no-admin --node https://rpc.atlantic-2.seinetwork.io
